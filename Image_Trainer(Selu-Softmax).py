...
model.add(Conv2D(32, (3, 3), input_shape=(32, 32, 3), activation='selu', padding='same', kernel_constraint=maxnorm(3)))
#Make sure all pixel read for more accurate guess
model.add(MaxPooling2D(pool_size=(2,2)))
model.add(Flatten())
#Distinguish image detail
model.add(Dense(512,activation='selu', kernel_constraint=maxnorm(3)))
